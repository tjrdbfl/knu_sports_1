...
import com.example.knu_sports_1.databinding.ActivityPlaceRacketBinding

class placeRacket : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceRacketBinding.inflate(layoutInflater)
