...
import com.example.knu_sports_1.databinding.ActivityPlaceGolfCourseBinding

class placeGolfCourse : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceGolfCourseBinding.inflate(layoutInflater)
