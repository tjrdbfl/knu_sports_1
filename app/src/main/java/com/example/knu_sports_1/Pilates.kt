...
class Pilates : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding=ActivityPilatesBinding.inflate(layoutInflater)
        ...
        tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            ...
            override fun onTabSelected(tab: TabLayout.Tab?) {
                ...
                when (tab?.text) {
                    "프로그램 안내" -> transaction.replace(R.id.tabContent,Pilates_fragmentOne())
                    "강사 안내" -> transaction.replace(R.id.tabContent, Pilates_fragmentTwo())
                }
                transaction.commit()
            }
            ...
            override fun onTabUnselected(tab: TabLayout.Tab?) {
                val transaction=supportFragmentManager.beginTransaction()
                when (tab?.text) {
                    "프로그램 안내" -> transaction.replace(R.id.tabContent,Pilates_fragmentTwo())
                    "강사 안내" -> transaction.replace(R.id.tabContent, Pilates_fragmentOne())
                }
                transaction.commit()
            }
