...
import com.example.knu_sports_1.databinding.ActivityPlaceSmallPlaygroundBinding

class placeSmallPlayground : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceSmallPlaygroundBinding.inflate(layoutInflater)
