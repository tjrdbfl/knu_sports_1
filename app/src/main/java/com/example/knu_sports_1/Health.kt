    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            ...
            override fun onTabSelected(tab: TabLayout.Tab?) {
                ...
                when (tab?.text) {
                    "프로그램 안내" -> transaction.replace(R.id.tabContent,Health_fragmentOne())
                    "강사 안내" -> transaction.replace(R.id.tabContent, Health_fragmentTwo())
                }
                transaction.commit()
            }
            ...
            override fun onTabUnselected(tab: TabLayout.Tab?) {
                val transaction=supportFragmentManager.beginTransaction()
                when (tab?.text) {
                    "프로그램 안내" -> transaction.replace(R.id.tabContent,Health_fragmentTwo())
                    "강사 안내" -> transaction.replace(R.id.tabContent, Health_fragmentOne())
                }
                transaction.commit()
            }
