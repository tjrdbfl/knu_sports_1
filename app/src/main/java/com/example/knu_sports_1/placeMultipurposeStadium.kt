...
import com.example.knu_sports_1.databinding.ActivityPlaceMultipurposeStadiumBinding

class placeMultipurposeStadium : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceMultipurposeStadiumBinding.inflate(layoutInflater)
