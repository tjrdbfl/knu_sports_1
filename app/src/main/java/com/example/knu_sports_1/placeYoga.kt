...
import com.example.knu_sports_1.databinding.ActivityPlaceYogaBinding

class placeYoga : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceYogaBinding.inflate(layoutInflater)
