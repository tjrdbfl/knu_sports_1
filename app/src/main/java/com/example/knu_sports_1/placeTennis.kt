...
import com.example.knu_sports_1.databinding.ActivityPlaceTennisBinding

class placeTennis : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceTennisBinding.inflate(layoutInflater)
