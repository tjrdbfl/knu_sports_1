...
import com.example.knu_sports_1.databinding.ActivityPlaceGymBinding

class placeGym : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceGymBinding.inflate(layoutInflater)
