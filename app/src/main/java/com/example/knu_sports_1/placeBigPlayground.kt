...
import com.example.knu_sports_1.databinding.ActivityPlaceBigPlaygroundBinding
import com.example.knu_sports_1.databinding.ActivityPlaceExteriorBinding

class placeBigPlayground : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceBigPlaygroundBinding.inflate(layoutInflater)
