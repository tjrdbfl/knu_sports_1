...
import com.example.knu_sports_1.databinding.ActivityPlaceSwimmingPoolBinding

class placeSwimmingPool : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPlaceSwimmingPoolBinding.inflate(layoutInflater)
